...
from dialogue_manager import *		# Importing all functions for advanced dialogue manager
...
def main():
    ...
    musky_the_manager = DialogueManager()
    musky_the_manager.create_chitchat_bot()
    bot = BotHandler(token, musky_the_manager)
